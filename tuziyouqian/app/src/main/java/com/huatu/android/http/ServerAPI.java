...
import com.huatu.android.bean.PhoneBean;
...
public interface ServerAPI {
   ...
   * String password = "服务密码";
   * String mobile = "手机号";
   */
  @FormUrlEncoded
  @POST("user/pullUserMobileAuth")
  Flowable<BaseBean> operatorConfirm(@Field("token") String token, @Field("mobile") String mobile, @Field("identityName") String identityName,
                                     @Field("identityNo") String identityNo, @Field("password") String password);
