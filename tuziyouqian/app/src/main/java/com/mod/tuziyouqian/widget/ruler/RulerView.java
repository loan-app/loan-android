package com.mod.tuziyouqian.widget.ruler;
...
public class RulerView extends View {
    ...
    public RulerView(Context context, AttributeSet attrs) {
        ...
        lineWidth = (int) typedArray.getDimension(R.styleable.RulerView_line_width, DisplayUtil.dip2px( 2));

        lineSpace = (int) typedArray.getDimension(R.styleable.RulerView_line_space, DisplayUtil.dip2px(10));

        lineGravity = typedArray.getInt(R.styleable.RulerView_line_gravity, 2);

        textSize = (int) typedArray.getDimension(R.styleable.RulerView_text_size,DisplayUtil.dip2px(18));
        ...
        indicatorSize = (int) typedArray.getDimension(R.styleable.RulerView_indicator_size, DisplayUtil.dip2px( 2));

        baseLineColor = typedArray.getColor(R.styleable.RulerView_base_line_color, Color.parseColor("#9B9B9B"));

        baseLineHeight = (int) typedArray.getDimension(R.styleable.RulerView_base_line_height, DisplayUtil.dip2px( 2));
...
//        minPaint.setStyle(Paint.Style.FILL);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minWidthSize = DisplayUtil.dip2px( 200);
        int minHeightSize = DisplayUtil.dip2px( 50);
        ...
        initDraw();
        initData();
        initLineHeight(DisplayUtil.dip2px( getResources().getDimension(R.dimen.DIMEN_24_0PX)));
    }

    protected void initLineHeight(int i) {
        textSize = DisplayUtil.dip2px(16);
        textPaint.setTextSize(textSize);
        maxLineHeight = (i - textSize) / 6 * 5;
        midLineHeight = (i - textSize) / 6 * 3;
