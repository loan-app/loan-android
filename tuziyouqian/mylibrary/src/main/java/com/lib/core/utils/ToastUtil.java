...
import static com.lib.core.baseapp.BaseApplication.getAppContext;
...
public class ToastUtil {
    ...
    private static Toast initToast(CharSequence message, int duration) {
        if (toast == null) {
            toast = Toast.makeText(getAppContext(), message, duration);
...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
        CharSequence msg = getAppContext().getResources().getText(strResId);
    ...
    public static void showLong(int strResId) {
        CharSequence msg = BaseApplication.getAppContext().getResources().getText(strResId);
        if (TextUtils.isEmpty(msg))
            return;
