...
/**
 * @author 周竹
 * @file PermissionUtils
 * @brief
 * @date 2017/12/12 上午11:27
...
public class PermissionUtils {
     ...
     * 用户申请权限返回
     */
    public static void onRequestPermissionResult(Fragment fragment, String permission, int[] grantResults, PermissionCheckCallBack callback) {
        if (PermissionUtils.isPermissionRequestSuccess(grantResults)) {
            callback.onHasPermission();
        } else {
            if (PermissionUtils.judgePermission(fragment.getActivity(), permission)) {
                callback.onUserHasAlreadyTurnedDown(permission);
            } else {
                callback.onUserHasAlreadyTurnedDownAndDontAsk(permission);
            }
    ...
    public static void showDialog(final Context mContext, final String content,long delayMillis) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                dialog.content(content)//
                        .contentTextColor(UiUtil.parseColor(R.color.color_333333))
                        .contentTextSize(14)
                        .widthScale(0.8f)
                        ...
                        .btnText("知道了", "去设置")
                        .btnTextSize(17, 17)
                        .btnTextColor(UiUtil.parseColor(R.color.color_5182e4), UiUtil.parseColor(R.color.color_5182e4))
                        .style(NormalDialog.STYLE_TWO)//
                        .titleTextSize(18)//
                        .titleTextColor(UiUtil.parseColor(R.color.color_333333))
                        .cornerRadius(10)
                        .show();
